...
<section class="bg-white border border-gray-100 rounded-2xl p-6 md:p-8 shadow-sm transition-all hover:shadow-md">
    ...
    <div class="flex flex-col gap-3">
        ...
        <div class="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center bg-gray-50 hover:bg-blue-50/50 hover:border-blue-300 transition-colors relative group">
            <span class="material-symbols-outlined text-[40px] text-gray-400 group-hover:text-blue-500 mb-4 transition-colors" data-icon="cloud_upload">cloud_upload</span>
            <input accept=".jpg,.jpeg,.png,.pdf" class="block w-full max-w-xs text-sm text-gray-500 file:mr-4 file:py-2.5 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-100 file:text-blue-700 hover:file:bg-blue-200 transition-colors cursor-pointer" id="dokumenKtp" name="file_identitas" required="" type="file">
        </div>
    </div>
</section>
